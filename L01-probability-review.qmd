...
Part of the challenge in working with conditional probability is the linguistic ambiguity inherent in natural language descriptions of conditioning. There are numerous ways to describe conditional probability in English. What goes to the right of the vertical bar is associated with phrases like "given that...", "of the...", "among the...", "conditional on...", "in cases where...", "subsequent to...", and "if...". It is common (possibly intentional at times) to flip conditional probabilities when making arguments. The "prosecutor's fallacy" is to give $P(\mathrm{evidence}|\mathrm{innocence})$ but interpret it as $P(\mathrm{innocence}|\mathrm{evidence})$. 
...
-   In the US, of women over age 40, assume that the distribution of the number of children is
...
To derive this, you could either use integration by parts or recognize that the integrand is proportional to the [gamma distribution](https://en.wikipedia.org/wiki/Gamma_distribution). For this class, feel free to use [Wolfram Alpha](https://www.wolframalpha.com/examples/mathematics/calculus-and-analysis) or [Integral Calculator](https://www.integral-calculator.com/) or similar sites to help you solve any problems in this class.
...
-   You have two randomly selected 40-year-old women. What is the expected total number of children that they have?
$$
