...
$$
\begin{split}
J(\beta) &\approx J(b) + (\beta-b)'
\begin{bmatrix} \frac{\partial J}{\partial\beta_0} \\ \vdots \\ \frac{\partial J}{\partial\beta_d} \end{bmatrix}  + \frac{1}{2}(\beta-b)'
\begin{bmatrix} \frac{\partial^2 J}{\partial\beta_0^2} & \cdots & \frac{\partial^2 J}{\partial\beta_0\partial\beta_d} \\ 
\vdots & \vdots & \vdots \\ 
\frac{\partial^2 J}{\partial\beta_0\partial\beta_d} & \cdots & \frac{\partial^2 J}{\partial\beta_d^2} \end{bmatrix}(\beta-b) \\
&= f(b) + (\beta-b)'\mathbf{G} + \frac{1}{2}(\beta-b)'\mathbf{H}(\beta-b) \\
\hat\beta &\leftarrow \hat\beta - \mathbf{H}^{-1}\mathbf{G}
\end{split}
$$
...
&= \sum_{i=1}^n -\mathbf{x}_i \frac{\partial}{\partial\beta} \frac{1}{1+e^{-\beta'\mathbf{x}_i}} \\
