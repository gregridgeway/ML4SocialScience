...
<!-- In terminal -->
<!-- quarto render L02-naive-Bayes.qmd -->

<!-- git commit L02* -m "commit message" -->
<!-- git status -->
<!-- git push -->
...
There are numerous other measures of performance. The [Table of Confusion](https://en.wikipedia.org/wiki/Confusion_matrix#Table_of_confusion) organizes them in their relationship to true positives, false positives, true negatives, and false negatives.
